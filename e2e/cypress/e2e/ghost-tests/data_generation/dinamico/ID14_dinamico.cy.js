...
context('#14 Cambiar la contraseña de un usuario por un tag', () => {
  ...
  it('Editar el nombre de un miembro', () => {
    ...
    cy.wrap(mockInterface.dynamicInitializeTags()).then(mockTag => {
      ...
      cy.get(changePasswordPage.elementNewPassword).type(new_tag);
      cy.get(changePasswordPage.elementVerifyPassword).type(new_tag);
      cy.wait(2000);
