...
class PostsPageGhost3 extends BasePage {

    async navigateToPosts(){
        let button = await this.driver.$('a[href^="posts"]')
        await button.click()
    }
    ...
    async updatePost(){
        ...
        let updateButton2 = await this.driver.$("span=Update");        
    ...
    async navigateToTabPosts() {
        let button = await this.driver.$('[href="#/posts/"]');
        await button.click();
      }
      ...
      async publishCurrentPost() {
        let publishButton = await this.driver.$('[class="gh-publishmenu ember-view"]');
        await publishButton.click();
        let continueButton = await this.driver.$('[class="gh-btn gh-btn-blue gh-publishmenu-button gh-btn-icon ember-view"]');
        await continueButton.click();
      }
      ...
      async deletePost(name) {
        ...
        let deleteButton = await this.driver.$("span=Delete post");
...
module.exports = PostsPageGhost3;
